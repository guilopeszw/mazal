...
Five people push to `main`. A red `main` blocks four people, and finding out at 03:00 that it went red at 22:00 costs the night. Run the test, watch it pass, commit, push. Small commits, often.

If you break `main`, say so in the group before you start fixing it.
